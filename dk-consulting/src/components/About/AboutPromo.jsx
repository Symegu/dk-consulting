...
export const AboutPromo = () => {
    return (
        <div className="h-[910px] bg-no-repeat bg-bottom bg-aboutpromo bg-cover">
            <div className="bg-gradient-to-r from-[#090A20] via-[#06082BE8] to-[#07093E14] h-full relative">
                <div className="flex absolute text-white font-extralight text-[16px] leading-[22px] top-[16px] right-[75px]">
                ...
                <div className="w-[calc(50%-90px)] bg-[#090A20] h-full relative">
                    <div className="absolute top-[203px] right-[35px]">
                        <div className="max-w-[550px] mb-[48px]">
                            <div className="flex items-center">
                                ...
                                <h1 className="bigTitle text-white ml-[10px]">НАША Миссия</h1>
                            </div>
                            <div className="w-[546px] h-[1px] bg-blue mb-[10px]"></div>
                            <p className="par text-white">&laquo;Совершенствование бизнеса наших клиентов для развития технологического потенциала России&raquo;</p>
                        </div>
                        <div className="max-w-[550px]">
                            <div className="flex items-center">
                                ...
                                <h1 className="bigTitle text-white ml-[10px]">Концепция</h1>
                            </div>
                            <div className="w-[546px] h-[1px] bg-blue mb-[10px]"></div>
                            <p className="par text-white">Системный подход к&nbsp;управлению бизнесом, а&nbsp;значит, и&nbsp;успех компании заключается в&nbsp;управлении триадой неразрывно связанных элементов&nbsp;&mdash; корпоративная культура\ресурсная база\процессы.</p>
                        </div>
                    </div>
                </div>
            </div>
