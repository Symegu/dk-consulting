...
export default function FourSteps() {
    return(
        <section className="max-w-[1440px] h-[350px] mx-auto">
            <Swiper
                slidesPerView={1}
                className="h-[350px]"
            >
                <SwiperSlide>
                    <div className="w-[100%] bg-chess flex justify-center items-end h-[350px] pr-[50px] text-white">
                        <div>
                            <h2 className="font-extralight text-[40px] leading-[56px] text-center">4 ШАГА К ИЗМЕНЕНИЮ</h2>
                            <p className="text-[26px] leading-[36px] text-center mb-[30px]">от анализа текущей ситуации до построения стратегии развития бизнеса</p>
                        </div>
                        <SlideNextButton />
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="bg-slide1 w-[1440px] h-[350px] mx-auto pl-[65px] pr-[50px]  flex  text-white items-center justify-between">
                        <div className="flex flex-row ">
                            <div className="max-w-[678px] pr-[32px] flex flex-col justify-between  pb-[60px]">
                                <h3 className=" text-center font-light text-[30px] leading-[42px] border-[3px] border-[#4D8BBE] w-[210px] rounded-[76px] mt-[76px] mb-[22px] h-[63px] pt-[10px]">
                                    1 ШАГ
                                </h3>
                                <div className="flex flex-row border-b-[1px] border-[#4D8BBE] items-center">
                                    ...
                                    <h4 className="font-light text-[36px] leading-[50px] ml-[10px]">Что с нами сейчас?</h4>
                                </div>
                                <p className="font-normal text-[22px] leading-[30px]">Диагностика производственной компании заключается в оценке качества следующих параметров:</p>
                            </div>
                ...
                <SwiperSlide>
                    <div className="bg-slide1 w-[1440px] h-[350px] pl-[65px] pr-[50px]   flex flex-row text-white items-center justify-between">
                        <div className="flex flex-row justify-between">
                            <div className="max-w-[678px] pr-[32px] flex flex-col justify-between pt-[48px] ">
                                ...
                                <div className="flex flex-row  items-center border-b-[1px] border-[#4D8BBE]">
                                    ...
                                    <h4 className="font-light text-[36px] leading-[50px] ml-[10px]">Какими ресурсами обладаем?</h4>
                                </div>
                                <p className="font-normal text-[22px] leading-[30px]">Анализ текущего состояния воплощается в оценке экономического потенциала предприятия:</p>
                            </div>
                            <div className="flex flex-row justify-between items-center w-[570px]">
                        ...
                        <div className="flex flex-row ">
                            <div className="max-w-[678px] pr-[32px] flex flex-col justify-between  pb-[60px]">
                                ...
                                <div className="flex flex-row border-b-[1px] border-[#4D8BBE] items-center">
                                    ...
                                    <h4 className="font-light text-[36px] leading-[50px] ml-[10px]">Чего хотим достичь?</h4>
                                </div>
                                <p className="font-normal text-[22px] leading-[30px]">На основании оценки потенциала выполняется формирование целей и ключевых показателей компании в выбранном горизонте:</p>
                            </div>
                        ...
                        <div className="flex flex-row ">
                            <div className="max-w-[678px] pr-[32px] flex flex-col justify-between  pb-[60px]">
                                ...
                                <div className="flex flex-row border-b-[1px] border-[#4D8BBE] items-center">
                                    ...
                                    <h4 className="font-light text-[36px] leading-[50px] ml-[10px]">Как будем достигать цели?</h4>
                                </div>
                                <p className="font-normal text-[22px] leading-[30px]">Разработка стратегии развития компании выражается в составлении методик достижения ключевых целей, таких как:
                                </p>
                            </div>
                            <div className="flex flex-row justify-between items-center">
                                <ul className="list-disc font-light text-[22px] leading-[30px] max-w-[560px]">
