    ...
    return (
        <section className="h-[350px] sm:h-[256px]  xs:h-[256px] mx-auto ">
            ...
            >
                ...
                <SwiperSlide>
                    <div className="bg-slide1 bg-no-repeat bg-cover bg-bottom w-[100%] h-[100%] px-[65px] text-white">
                ...
                <SwiperSlide className="hidden md:block sm:block">
                    <div className="flex flex-col bg-slide1 bg-no-repeat bg-cover bg-bottom  text-white items-center justify-center h-[100%] w-[100%]">
                ...
                <SwiperSlide className="hidden md:block">
                    <div className="flex flex-col bg-slide1 bg-no-repeat bg-cover bg-bottom  text-white items-center justify-center h-[350px] sm:h-[256px]">
                ...
                <SwiperSlide className="hidden md:block sm:block">
                    <div className="flex flex-col bg-slide1 bg-no-repeat bg-cover bg-bottom  text-white items-center justify-center w-[100%] h-[100%]">
                        <ul className="list-disc font-light text-[22px] leading-[30px] sm:leading-[20px] sm:text-[15px]  ">
                            <li>
                                <p>
                                    Внедрение инструментов lean production
