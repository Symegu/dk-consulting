...
export const AboutPromo = () => {
    return (
        <div className="about-promo">
            <div className="about-promo__wrap">
                <div>
                    <h1>
                    ...
                    <div className="about-promo__line"></div>
                    <p>&laquo;Совершенствование бизнеса наших клиентов для развития технологического потенциала России&raquo;</p>
                </div>
                <div>
                    <h1>
                    ...
                    <div className="about-promo__line"></div>
                    <p>Системный подход к&nbsp;управлению бизнесом, а&nbsp;значит, и&nbsp;успех компании заключается в&nbsp;управлении триадой неразрывно связанных элементов&nbsp;&mdash; корпоративная культура\ресурсная база\процессы.</p>
                </div>
            </div>
        </div>
    )
