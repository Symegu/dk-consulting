    ...
    return (
        ...
        >
            ...
            <section
                className={
                    msgVisible
                        ? "bg-[rgba(0,0,0,0.5)]  fixed z-[1000] top-0 w-full h-[100vh] flex flex-col items-center justify-center"
                        : "hidden"
                }
            >
                <div className="bg-white relative flex flex-col items-center  justify-center w-[400px] h-[300px] rounded-[30px]">
                    <button
