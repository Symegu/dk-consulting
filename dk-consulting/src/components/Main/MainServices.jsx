        ...
        <section className="pt-[43px] pb-[100px] max-w-[1290px] mx-auto lg:max-w-[940px] lg:pt-[60px] lg:pb-0 md:max-w-[940px] md:pt-[50px] md:pb-0 sm:hidden xs:hidden">
            ...
            <ul className="flex items-start justify-between w-full lg:justify-center lg:flex-wrap md:justify-center md:flex-wrap">
                <li className="flex flex-col items-center w-full group lg:flex-col-reverse lg:w-[310px] lg:mr-[80px] md:flex-col-reverse md:w-[310px] md:mr-[20px]">
                    <h4 className="text-[16px] text-grey w-[305.5px] border-2 border-grey rounded-[8px] text-center py-[22px] mb-[62px] group-hover:bg-blue  group-hover:text-white ease-in-out duration-300 lg:w-[223px] lg:py-[14px] lg:h-[60px] lg:mt-[20px] md:w-[223px] md:py-[14px] md:h-[60px] md:mt-[20px]">АУДИТ</h4>
                ...
                <li className="flex flex-col items-center w-full group  lg:flex-col-reverse lg:w-[310px] lg:ml-[80px] md:flex-col-reverse md:w-[310px] md:ml-[20px]">
                    <h4 className="text-[16px] text-grey w-[305.5px] border-2 border-grey rounded-[8px] text-center py-[22px] mb-[62px] group-hover:bg-blue group-hover:text-white ease-in-out duration-300  lg:w-[223px] lg:py-[4px] lg:h-[60px] lg:mt-[20px] md:w-[223px] md:py-[4px] md:h-[60px] md:mt-[20px]">ПРОМЫШЛЕННЫЙ КОНСАЛТИНГ</h4>
                ...
                <li className="flex flex-col items-center w-full group  lg:flex-col-reverse lg:w-[310px] lg:mr-[80px] md:flex-col-reverse md:w-[310px] md:mr-[20px]">
                    <h4 className="text-[16px] text-grey w-[305.5px] border-2 border-grey rounded-[8px] text-center py-[22px] mb-[62px] group-hover:bg-blue group-hover:text-white ease-in-out duration-300  lg:w-[223px] lg:py-[4px] lg:h-[60px] lg:mt-[20px] md:w-[223px] md:py-[4px] md:h-[60px] md:mt-[20px]">ОРГАНИЗАЦИЯ ПРОИЗВОДСТВА</h4>
                    <ul className="flex flex-col items-center w-[305.5px] group-hover:bg-blue group-hover:text-white ease-in-out duration-300  rounded-[8px] relative">
                ...
                <li className="flex flex-col items-center w-full group  lg:flex-col-reverse lg:w-[310px] lg:ml-[80px] md:flex-col-reverse md:w-[310px] md:ml-[20px]">
                    <h4 className="text-[16px] text-grey w-[305.5px] border-2 border-grey rounded-[8px] text-center py-[22px] mb-[62px] group-hover:bg-blue group-hover:text-white ease-in-out duration-300  lg:w-[223px] lg:py-[14px] lg:h-[60px] lg:mt-[20px] md:w-[223px] md:py-[14px] md:h-[60px] md:mt-[20px]">ОБУЧЕНИЕ</h4>
